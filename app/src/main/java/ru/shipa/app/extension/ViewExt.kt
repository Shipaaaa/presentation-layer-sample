...
import ru.shipa.app.presentation.utils.GlideApp
 ...
 * текстовые стили у [MaterialR.id.snackbar_text] и [MaterialR.id.snackbar_action]
 *
...
fun Snackbar.decorate(@ColorRes backgroundId: Int, @ColorRes textColorId: Int): Snackbar {
    ...
    with(view.findViewById<TextView>(MaterialR.id.snackbar_text)) {
    ...
    // Изменение текстового стиля
    with(view.findViewById<TextView>(MaterialR.id.snackbar_action)) {
        setTextColor(ContextCompat.getColor(view.context, textColorId))
    }
